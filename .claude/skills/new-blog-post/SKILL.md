...
5. **Show the user** the file diff and the local URL (`/blog/YYYY/MM/DD/slug/`).
...
- Post permalink is `/blog/YYYY/MM/DD/slug/` derived from `date` + title. Override with `slug: custom-slug` in front-matter if needed.
